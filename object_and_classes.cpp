...
*/
LightClass::LightClass(bool st, int br) : state(st), brightness(br) // initiliizing list
/*
...
void LightClass::turnOn()
{
    state = true;
}

void LightClass::turnOff()
{
    state = false;
}
...
void LightClass::setBrightness(int n)
{
    brightness = n;
}
