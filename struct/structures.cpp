...
int main() {
        ...
        std::cout << "The distance of d1: " << d1.feet << "'" << d1.inches << "\"" << std::endl
                  << std::endl;

        Distance d2 = {5, 7}; /* d2 is initialized in order by which
                               they are crated inside the structure */
        std::cout << "The distance of d2: " << d2.feet << "'" << d2.inches << "\"" << std::endl
                  << std::endl;
        ...
        Rectangle R = {
                {2, 3},
                {3, 5}
        };  // initializing rectangle type variable
        ...
        for (int i = 0; i < 5; i++) dist[i] = {3 * i, i + 1};

        for (int i = 0; i < 5; i++)
                std::cout << dist[i].feet << "'" << dist[i].inches << "\"" << std::endl;
        ...
        for (int i = 0; i < 5; i++)
                std::cout << dist1[i].feet << "'" << dist1[i].inches << "\"" << std::endl;
        std::cout << std::endl;
